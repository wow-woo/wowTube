...
var txt_comment = document.querySelector("#form_comment > textarea");
var list_comments = document.querySelector("#list_comments");
var span_commentCount = document.querySelector("#span_commentCount");
var btn_comment_delete = document.querySelectorAll(".btn_comment_delete");
...
if (form_comment) {
  ...
  var deleteComment = function deleteComment() {
    btn_comment_delete.forEach(function (btn) {
      btn.addEventListener("click", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
          var li, text, timeDiff, payload, videoURL, Dcomment;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  li = e.currentTarget.parentNode.parentNode;
                  text = li.querySelector(".comment_text").textContent;
                  timeDiff = li.querySelector(".time_diff").textContent;
                  payload = JSON.stringify({
                    text: text,
                    timeDiff: timeDiff
                  });
                  console.log("payload", payload);
                  videoURL = window.location.href.split("/videos/");
                  _context.prev = 6;
                  _context.next = 9;
                  return fetch("/api/".concat(videoURL[1], "/comment/delete"), {
                    method: "POST",
                    headers: {
                ...
                case 9:
                  Dcomment = _context.sent;

                  if (Dcomment.status === 200) {
                    console.log("green light"); //delete comment on front
  ...
  var addTempComment = function addTempComment(comment) {
    var li = document.createElement("li");
    var span = document.createElement("span");
    span.textContent = comment;
    li.appendChild(span); // list_comments.prepend(li);

    list_comments.insertBefore(li, list_comments.firstChild);
  };

  var commentCountUp = function commentCountUp(e) {
    span_commentCount.textContent++;
  };

  var commentCountDown = function commentCountDown(e) {
    span_commentCount.textContent--;
  };

  var addComment = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var payload, videoURL, res;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 3;
              _context2.next = 6;
              return fetch("/api/".concat(videoURL[1], "/comment/add"), {
                headers: {
                  "Content-Type": "application/json"
                },
                method: "POST",
...
/* harmony import */ var _comment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_comment__WEBPACK_IMPORTED_MODULE_3__);
...
var videoConfig = function videoConfig() {
  ...
  var countView = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var video_views, ViewURL, res, data;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              video_views = document.querySelector(".video-views");
              ViewURL = window.location.href.split("/videos/");
              _context.next = 4;
              return fetch("".concat(ViewURL[0], "/api/").concat(ViewURL[1], "/view"), {
                method: "POST"
              });
            ...
            case 9:
              ...
              if (video_views) {
                video_views.textContent = "".concat(data, " views");
              }
  ...
  var scaleVideo = /*#__PURE__*/function () {
    ...
    return function scaleVideo(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  ...
  var timeHandler = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var blob, duration, totalDuration, grant, timeChecker;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch(videoPlayer.src).then(function (res) {
                return res.blob();
              });
            ...
            case 5:
              ...
              totalDuration = timeFormat(duration);
              grant = -1;

              timeChecker = function timeChecker() {
    ...
    return function timeHandler(_x3) {
...
module.exports = __webpack_require__(/*! C:\Users\UNI\OneDrive\wow-woo\server\assets\js\main.js */"./assets/js/main.js");
